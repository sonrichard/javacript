...
function finalizar() {
    if (valores.length == 0) {
        ...
        res.innerHTML += `<p>O maior numero registrado foi ${maior}.</p>`
        res.innerHTML += `<p>O menor numero registrado foi ${menor}.</p>`
        res.innerHTML += `<p>Somando todos os valores temos ${soma}.</p>`
        res.innerHTML += `<p>A media entre os numeros é ${media}</p>`
    }
}